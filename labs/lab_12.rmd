...
**A1.** The leading word, “failing,” highlights that most sanctions involve some form of lapse in duty. Broadly, the top words point to issues with trust, professional conduct, and financial responsibility, such as mishandling client funds or failing to act properly for clients. Overall, the sanctions reflect breaches of ethical and professional obligations in legal practice. 
...
**A2.** The top two trigrams were conduct involving dishonesty and dishonesty fraud deceit. The top trigrams both signal serious ethical violations by attorneys. They indicate behavior that breaches the duty of honesty, including lying, misrepresenting facts, or intentionally misleading clients or courts. Broadly, these phrases highlight the most severe forms of professional misconduct, emphasizing breaches of trust, ethics, and legal obligations.

```{r}
top_trigram <- md_attorney_sanctions |>
...
**A3.** The table shows that the number of cases referencing “conduct involving dishonesty” has increased in recent years, suggesting that dishonesty-related misconduct is becoming a more prominent reason for sanctions. This indicates that breaches of trust and ethical obligations continue to be a major focus of disciplinary action. To further clarify the most important reasons attorneys get sanctioned, you could analyze the top 5–10 trigrams over time, group related phrases into categories like financial or ethical violations, and examine which behaviors lead to more severe penalties.

```{r}
top_trigram <- "conduct involving dishonesty"

trigram_by_year <- md_attorney_sanctions |> 
  group_by(fiscal_year) |> 
  summarise(
    conduct_dishonesty = sum(str_detect(text, fixed(top_trigram))),
    .groups = "drop"
  ) |> 
  arrange(fiscal_year)
