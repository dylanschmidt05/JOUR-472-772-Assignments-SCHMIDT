...
**A2** There are nine total and the most recent one was in 2021.
...
raw <- page |> html_nodes("body") |> html_text2()
...
**A3** 
1. What issues does Sen. Cardin talk about most often?
2. How does his communication shift over time?
3. What topics spike during election years?
...
dates <- page |> 
  html_elements(".posted-on time") |>  
  html_text() |> 
  as.data.frame()

cardin_df <- bind_cols(dates, titles, urls)
