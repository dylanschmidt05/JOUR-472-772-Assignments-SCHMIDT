...
```{r}
library(axolotr)
create_credentials(GROQ_API_KEY = "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")
```
...
class_response <- axolotr::ask(
  prompt = "If I am trying to get in touch with a Public Informations Officer at a Police Department to pass along an MPIA request but am having no success, what is the best and most professional way to go about getting a response from the person",
  model = "llama-3.1-8b-instant"
)
...
**Your comment:**
I would say that the response I got is appropriate and correct given that is how I have been taught to approach this situation.
