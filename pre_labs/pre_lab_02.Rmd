...
1.  How many UMD courses are at each level? So how many 100 level classes are there, 200 level and so on?

2.  Who are the top five payees in the Maryland expense dataset?

3.  What committee collected the most money?
