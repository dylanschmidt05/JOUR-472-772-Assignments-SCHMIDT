...
```{r echo=FALSE}
#census_api_key("32c7c8456bb377207fb27f42605f3048c5e44ba7", install=TRUE)
```
...
**Task** What is another question you could ask of this data? **Answer** What county has the lowest percent of high school graduates enrolled?
