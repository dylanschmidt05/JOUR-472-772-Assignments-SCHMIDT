...
**Task** Load the five CSV files. Do they have the same column structure? **Answer** Yes, they all have the same structure, with the only difference as the year listed under the year column.
...
**Task** Run the following code to join Maryland population data and the 2020 voter registration data together using the common column county as the key. How many rows are there now? How many *should* there be? **Answer** 24 rows
