...
**Answer** 79,366 obs and 9 variables
...
Id is a string and seats is an integer
...
**Answer** It is arranging each of the classes in the data by the term and producing a column called count_classes which gives us the number of classes from each term. The last line of the code arranges the number of classes from highest to lowest.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** The number of classes in each term is arranged from highest to lowest
...
**Answer** The output is now the number of sections of each class offered in each term. So for example, there were six African American Studies classes in the term 201712. The group_by changed from term to term, department and so did the arrange.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** We can now see the total number of seats in each term.
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** We added the mean and median number of seats in the classes offered in each term. The top terms are arranged by the highest number of seats. 
...
**Answer** We can now see the minimum number of seats and maximum number of seats in each department, based on the class size.
...
1.  Where does the business and management department rank in terms of the mean number of seats? 

2.  Which department has the highest maximum seat total?

3.  Which department has the lowest number of total classes?
